...
dataB(1).dof = zeros(Time/dt,6);         %the dof value from data(1) is put in array with only zeros of size (time / dt, 4)
dataB(1).target = zeros(Time/dt,2);      %the target value from data(1) is put in array with only zeros of size (time / dt, 2)
dataB(1).cursor = zeros(Time/dt,3);      %the cursor value from data(1) is put in array with only zeros of size (time / dt, 2)
dataB(1).sysOut = zeros(Time/dt,3);      %the sysOut value from data(1) is put in array with only zeros of size (time / dt, 2)
